...
const TEXT_QUESTIONS = [
  {
    ...
    caption: 'Undertone patterns differ across skin types. This helps us interpret your photos more accurately.',
    type: 'choice',
    options: [
  ...
  {
    id: 'skinDepth',
    label: 'What is your natural skin depth?',
  ...
  {
    id: 'seasonalChange',
    label: 'Does your skin tone shift between seasons?',
    caption: 'Some people are noticeably deeper in summer and lighter in winter.',
    type: 'choice',
    options: [
      { label: 'Yes — I tan significantly',  value: 'darker_in_summer' },
      { label: 'Slightly',                   value: 'slight_change' },
      { label: 'No — stays consistent',      value: 'none' },
    ],
  },
  {
    id: 'bestWhite',
    label: 'Hold a bright white and a cream up to your bare face. Which looks better?',
    caption: 'No makeup. Natural light if possible. Which makes your skin look healthier?',
    type: 'choice',
    options: [
