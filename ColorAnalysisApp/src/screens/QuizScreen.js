...
const TEXT_QUESTIONS = [
  {
    id: 'skinDepth',
    label: 'How deep is your natural skin tone?',
    caption: 'Bare skin, no makeup, neutral light.',
    type: 'choice',
    options: [
  ...
  {
    id: 'skinUndertone',
    label: 'What cast do you see on your inner wrist?',
    caption: 'Natural daylight, bare skin.',
    type: 'choice',
    options: [
      ...
      { label: 'Bluish / cool',      value: 'blue_pink' },
  ...
  },
  {
    ...
    caption: 'Which metal looks better against your bare skin?',
    type: 'choice',
    options: [
  ...
  {
    id: 'bestWhite',
    label: 'Bright white or cream?',
    caption: 'Hold each up to your face. Which one makes your skin look alive?',
    type: 'choice',
    options: [
      { label: 'Bright white',   value: 'pure_white', swatch: '#FFFFFF' },
      { label: 'Cream / ivory',  value: 'cream',      swatch: '#FFF8E7' },
      { label: 'Both are fine',  value: 'both' },
    ],
  },
  {
    id: 'featureClarity',
    label: 'How defined are your natural features?',
    caption: 'Think skin, brows, lashes — no makeup.',
    type: 'choice',
    options: [
      { label: 'Very striking',         value: 'very_clear' },
      { label: 'Fairly defined',        value: 'fairly_clear' },
      { label: 'Soft, blends together', value: 'somewhat_soft' },
      { label: 'Very subtle',           value: 'very_soft' },
    ],
  },
  {
    id: 'contrast',
    label: 'Light-to-dark contrast across your face?',
    caption: 'Difference between your skin and your darkest features.',
    type: 'choice',
    options: [
      { label: 'Very high — striking', value: 'very_high' },
      { label: 'High',                 value: 'high' },
      { label: 'Medium',               value: 'medium' },
      { label: 'Low — blends',         value: 'low' },
    ],
  },
];
