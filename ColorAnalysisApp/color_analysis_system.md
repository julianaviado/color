...
These are the specific observations to make during every photo-by-photo analysis. Call out each one when the relevant color appears in the photos.
...
- **Salmon or warm pink**: Turns orange on cool skin = cool undertone. Harmonizes naturally on warm skin = warm undertone. This is one of the most reliable undertone diagnostic colors.
...
- **Warm burgundy/marsala**: Consistently one of the most revealing colors. If it rates 8.5–10 across multiple photos = strong warm + muted confirmation. If a version of burgundy rates lower, check — is it cool-toned (purple cast) or warm-toned (brown cast)?
...
These are the specific skin effects to look for and name in every photo:
...
### Consistency Tracking (for multi-photo sets)
- Note when the same color family appears in multiple photos and track whether it consistently scores the same way
- A color that rates 9/10 in one lighting condition and 4/10 in another is likely affected by lighting, not the color itself — note this
- A color that rates 8–9/10 across 5+ photos in different lighting = definitive confirmation of that color family
- Call out patterns explicitly: "Burgundy has rated 8.5–9.5 across 6 photos — this is her most reliable color family"
- Call out when black appears repeatedly and consistently underperforms: "Black has rated 3–4/10 in 10+ photos — this is definitively her worst color"
...
- What is your confidence level in the undertone determination? (e.g., 90% confident warm)
